...
class TaskScreen extends StatefulWidget {
  final int id;
  const TaskScreen({super.key, required this.id, required this.updateParent});
...
class _TaskScreenState extends State<TaskScreen> {
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    timeWithAMPM(task.from!, context),
                    const SizedBox(
                      width: 10,
                    ),
                    const Icon(
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  await showDialog(
                    ...
                    if (value == true) {
                      await context.read<TaskProv>().deleteTaskById(widget.id);
                      widget.updateParent();
                      nav.pop();
                    }
                  });
  ...
  Widget timeWithAMPM(DateTime dateTime, BuildContext context) {
    ...
    return Row(
      ...
      children: [
        Text(
          timeOfDay
              .format(context)
              .substring(0, timeOfDay.format(context).length - 2),
